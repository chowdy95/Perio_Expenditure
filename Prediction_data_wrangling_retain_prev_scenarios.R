...
write_csv(prediction_selection_short, "outputs/short_final_selected_output_increased_maintenance.csv")
write_csv(prediction_selection, "outputs/final_selected_output_increased_maintenance.csv")
...
write_csv(sev_combined %>% dplyr::select(Country, Severity, selected_Mean_total_billions, selected_SD_total_billions),
          "outputs/country_sev_selected_increased_maintenance.csv")

write_csv(proc_combined %>% dplyr::select(Country, Procedure, selected_Mean_total_billions, selected_SD_total_billions),
          "outputs/procedure_selected_increased_maintenance.csv")

write_csv(global_severity, "outputs/global_severity_increased_maintenance.csv")
write_csv(global_procedure, "outputs/global_procedure_increased_maintenance.csv")
